DROP DATABASE IF EXISTS cc1mb_202307793_postgresql;

DROP USER IF EXISTS "Joao Moura";

CREATE USER "Joao Moura" WITH PASSWORD '22112003';

CREATE DATABASE cc1mb_202307793_postgresql;
